<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        ...
        <a href="#" class="app-brand-link">
            <!-- <span  class="app-brand-logo demo mb-3">
             <img width="150" viewBox="0 0 25 42" src="{{asset('/assets/img/img/logo vermelha.png')}}"  />
            </span> -->
                        ...
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                            <g id="Icon" transform="translate(27.000000, 15.000000)">
                                <g id="Mask" transform="translate(0.000000, 8.000000)">
                                    ...
                                    <use fill="#c01010" xlink:href="#path-1"></use>
                                    <g id="Path-3" mask="url(#mask-2)">
                                        <use fill="#c01010" xlink:href="#path-3"></use>
                                        <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-3"></use>
                                    </g>
                                    <g id="Path-4" mask="url(#mask-2)">
                                        <use fill="#c01010" xlink:href="#path-4"></use>
                                        <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-4"></use>
                                    </g>
                                </g>
                                <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
                                    <use fill="#c01010" xlink:href="#path-5"></use>
        ...
        <span class=" menu-text fw-bolder mt-2 ms-2" style="color:#f01414">Control<span class=" menu-text fw-bolder mt-2" style="color:#ffffff"> Hub</span></span>
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- <li class="menu-item {{'posts/social' == request()->path() ? 'active' : ''}}">
            ...
            <ul class="menu-sub">
                <li class="menu-item ">
                    <a href="/posts/social" class="menu-link">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Página</span>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
