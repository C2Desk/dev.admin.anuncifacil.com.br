                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Insira o Título" name="titulo_post" value="{{$post->titulo}}"/>
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Sub-título</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Sub-título" name="sub_titulo_post" value="{{$post->sub_titulo}}" />
                        </div>
